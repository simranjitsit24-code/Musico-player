...
function NavBar() {
  return (
    <div className="h-full w-72 bg-[#03150f]/96 text-emerald-50 flex flex-col px-6 py-8 overflow-y-auto border-r border-emerald-300/30 scrollbar-hide shadow-[inset_-1px_0_0_rgba(16,185,129,0.2),0_8px_30px_rgba(0,0,0,0.35)]">
      {/* Logo */}
      ...
      <div className="mb-10">
        ...
        <nav className="space-y-3">
          <div className="flex items-center gap-3 px-3 py-2 rounded-xl bg-emerald-300/12 hover:bg-emerald-300/20 cursor-pointer transition-colors group border border-emerald-300/30 shadow-[0_0_18px_rgba(16,185,129,0.18)]">
            <House size={15} className="text-emerald-100" />
            <span className="text-sm font-medium group-hover:text-white">Home</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-emerald-200/14 cursor-pointer transition-colors group">
      ...
      <div>
        ...
        <nav className="space-y-3">
          <div className="flex items-center gap-3 px-3 py-2 rounded-xl cursor-pointer transition-colors group bg-emerald-300/15 border border-emerald-300/30 shadow-[0_0_14px_rgba(16,185,129,0.15)]">
